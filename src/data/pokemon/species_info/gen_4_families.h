...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_OVERCOAT, ABILITY_NONE, ABILITY_LIBERO },
    ...
    [SPECIES_GROTLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SEED_SOWER, ABILITY_NONE, ABILITY_AIR_LOCK },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_TORTERRA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_MISTY_SURGE, ABILITY_NONE, ABILITY_THICK_FAT },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_ICE_BODY, ABILITY_NONE, ABILITY_LIBERO },
    ...
    [SPECIES_MONFERNO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PIXILATE, ABILITY_NONE, ABILITY_COMPOUND_EYES },
        .bodyColor = BODY_COLOR_BROWN,
        .noFlip = TRUE,
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_BATTERY, ABILITY_NONE, ABILITY_SYNCHRONIZE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_SURGE_SURFER, ABILITY_NONE, ABILITY_DRAGONS_MAW },
    #else
        .abilities = { ABILITY_MERCILESS, ABILITY_NONE, ABILITY_FLOWER_GIFT },
    #endif
    ...
    [SPECIES_PRINPLUP] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_SLUSH_RUSH, ABILITY_NONE, ABILITY_MAGNET_PULL },
    #else
        .abilities = { ABILITY_MERCILESS, ABILITY_NONE, ABILITY_SOLID_ROCK },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_EMPOLEON] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_9
        .abilities = { ABILITY_INSOMNIA, ABILITY_NONE, ABILITY_CHEEK_POUCH },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_SWEET_VEIL },
    #endif
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_STARLY] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_ARENA_TRAP },
    #else
    ...
    [SPECIES_STARAVIA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_ILLUSION, ABILITY_NONE, ABILITY_RIPEN },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STARAPTOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_NONE, ABILITY_ICE_SCALES },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STARAPTOR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_DAUNTLESS_SHIELD, ABILITY_SPEED_BOOST, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Staraptor"),
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_HEAVY_METAL, ABILITY_SLOW_START },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BIBAREL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOTOR_DRIVE, ABILITY_BEADS_OF_RUIN, ABILITY_SPICY_SPRAY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_WIND_POWER, ABILITY_NONE, ABILITY_TANGLING_HAIR },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_PLUS, ABILITY_NONE, ABILITY_IMPOSTER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_BAD_DREAMS, ABILITY_SAP_SIPPER, ABILITY_MARVEL_SCALE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WONDER_GUARD, ABILITY_SHEER_FORCE, ABILITY_DAZZLING },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Luxio"),
        .cryId = CRY_LUXIO,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MIRROR_ARMOR, ABILITY_SWIFT_SWIM, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_CURIOUS_MEDICINE, ABILITY_NONE, ABILITY_DRAGONIZE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_RAMPARDOS] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_PROTOSYNTHESIS, ABILITY_NONE, ABILITY_STATIC },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_THERMAL_EXCHANGE, ABILITY_NONE, ABILITY_EMBODY_ASPECT_TEAL_MASK },
    ...
    [SPECIES_BASTIODON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_CONTRARY, ABILITY_NONE, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_MUMMY, ABILITY_NONE, ABILITY_BEAST_BOOST },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_STENCH, ABILITY_NONE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
        .natDexNum = NATIONAL_DEX_BURMY,
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_CONTRARY, ABILITY_NONE, ABILITY_HOSPITALITY },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
        .natDexNum = NATIONAL_DEX_BURMY,
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FLUFFY, ABILITY_NONE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_RAIN_DISH, ABILITY_NONE, ABILITY_GUARD_DOG },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_AURA_BREAK, ABILITY_NONE, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO                                                 \
    {                                                                       \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                   \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),                         \
        .abilities = { ABILITY_ROCKY_PAYLOAD, ABILITY_NONE, ABILITY_SWORD_OF_RUIN },  \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_GRIM_NEIGH, ABILITY_NONE, ABILITY_OPPORTUNIST },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_NONE, ABILITY_LIQUID_VOICE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_PACHIRISU] =
    {
        ...
        .abilities = { ABILITY_ICE_SCALES, ABILITY_SHADOW_TAG, ABILITY_LONG_REACH },
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_MERCILESS, ABILITY_NONE, ABILITY_FRIEND_GUARD },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_FLOATZEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_NONE, ABILITY_DARK_AURA },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHELLOS_WEST] =
    {
        ...
        .abilities = { ABILITY_TRUANT, ABILITY_EMBODY_ASPECT_CORNERSTONE_MASK, ABILITY_REFRIGERATE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SHELLOS_EAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_ROCK_HEAD, ABILITY_SHADOW_TAG, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shellos"),
        .cryId = CRY_SHELLOS,
        .natDexNum = NATIONAL_DEX_SHELLOS,
    ...
    [SPECIES_GASTRODON_WEST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_TABLETS_OF_RUIN, ABILITY_GALE_WINGS, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GASTRODON_EAST] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_SCREEN_CLEANER, ABILITY_QUICK_FEET },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gastrodon"),
        .cryId = CRY_GASTRODON,
        .natDexNum = NATIONAL_DEX_GASTRODON,
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_DROUGHT, ABILITY_SWIFT_SWIM, ABILITY_MIRROR_ARMOR },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_DRIFBLIM] =
    {
        ...
        .growthRate = GROWTH_FLUCTUATING,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_SHIELD_DUST, ABILITY_MOXIE, ABILITY_SUPER_LUCK },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_BUNEARY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SHADOW_TAG, ABILITY_MOLD_BREAKER, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_TERAVOLT, ABILITY_ZEN_MODE, ABILITY_THERMAL_EXCHANGE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LOPUNNY_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SCHOOLING, ABILITY_SWORD_OF_RUIN, ABILITY_ICE_FACE },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Lopunny"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GLAMEOW] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FRIEND_GUARD, ABILITY_SHIELD_DUST, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUSION, ABILITY_DARK_AURA, ABILITY_WONDER_GUARD },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_OVERCOAT, ABILITY_LIQUID_OOZE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_WIMP_OUT, ABILITY_MISTY_SURGE, ABILITY_DISGUISE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BRONZOR] =
    {
        ...
        .abilities = { ABILITY_FULL_METAL_BODY, ABILITY_SLUSH_RUSH, ABILITY_GALE_WINGS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BRONZONG] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNIPER, ABILITY_UNSEEN_FIST, ABILITY_WIMP_OUT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_PURIFYING_SALT, ABILITY_HARVEST, ABILITY_SOUNDPROOF },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_RECEIVER, ABILITY_NONE, ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { ABILITY_RKS_SYSTEM, ABILITY_NONE, ABILITY_MEGA_SOL },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_GABITE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_NONE, ABILITY_TABLETS_OF_RUIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GARCHOMP] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_MOXIE, ABILITY_NONE, ABILITY_PROTEAN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_GARCHOMP_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_PICKUP, ABILITY_WATER_VEIL, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Garchomp"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GARCHOMP_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_JUSTIFIED, ABILITY_NONE, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Garchomp"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { ABILITY_NEUROFORCE, ABILITY_MEGA_SOL, ABILITY_POWER_OF_ALCHEMY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    [SPECIES_LUCARIO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DRY_SKIN, ABILITY_PRISM_ARMOR, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUCARIO_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_INTIMIDATE, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lucario"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_LUCARIO_MEGA_Z] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_PSYCHIC_SURGE, ABILITY_POISON_TOUCH, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Lucario"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_HIPPOWDON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DESOLATE_LAND, ABILITY_NONE, ABILITY_SEED_SOWER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SKORUPI] =
    {
        ...
        .abilities = { ABILITY_ANGER_POINT, ABILITY_COLOR_CHANGE, ABILITY_PURE_POWER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_DRAPION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_SPICY_SPRAY, ABILITY_GRASSY_SURGE, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_ILLUMINATE, ABILITY_FLOWER_GIFT },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_DELTA_STREAM, ABILITY_PRIMORDIAL_SEA, ABILITY_BERSERK },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_FINNEON] =
    {
        ...
        .abilities = { ABILITY_IMMUNITY, ABILITY_FIRE_MANE, ABILITY_STEADFAST },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_LIBERO, ABILITY_EMERGENCY_EXIT, ABILITY_WATER_COMPACTION },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_NONE, ABILITY_MAGMA_ARMOR },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ABOMASNOW] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_MINDS_EYE, ABILITY_NONE, ABILITY_ARENA_TRAP },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ABOMASNOW_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_ZERO_TO_HERO, ABILITY_DELTA_STREAM, ABILITY_SCHOOLING },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Abomasnow"),
    #if P_MODIFIED_MEGA_CRIES
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_DIALGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COSTAR, ABILITY_NONE, ABILITY_SHED_SKIN },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_DIALGA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_TOXIC_BOOST, ABILITY_NONE, ABILITY_MULTISCALE },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Dialga"),
        .cryId = CRY_DIALGA,
        .natDexNum = NATIONAL_DEX_DIALGA,
    ...
    [SPECIES_PALKIA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_NEUROFORCE, ABILITY_NONE, ABILITY_FILTER },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_PALKIA_ORIGIN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_ILLUSION, ABILITY_NONE, ABILITY_PASTEL_VEIL },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Palkia"),
        .cryId = CRY_PALKIA,
        .natDexNum = NATIONAL_DEX_PALKIA,
    ...
    [SPECIES_HEATRAN_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DROUGHT, ABILITY_NONE, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Heatran"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_GIRATINA_ALTERED] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_POISON_HEAL, ABILITY_NONE, ABILITY_PRISM_ARMOR },
        .bodyColor = BODY_COLOR_BLACK,
