// Auto-generated by tools/randomizer/generate_wild_pool.py -- do not hand edit.
// Regenerate with: python3 tools/randomizer/generate_wild_pool.py
#ifndef GUARD_DATA_RANDOMIZER_WILD_POOL_H
#define GUARD_DATA_RANDOMIZER_WILD_POOL_H

#include "constants/species.h"

static const u16 sRandomizerWildPool[] =
{
    SPECIES_BULBASAUR,
    SPECIES_IVYSAUR,
    SPECIES_VENUSAUR,
...
#define RANDOMIZER_WILD_POOL_COUNT (sizeof(sRandomizerWildPool) / sizeof(sRandomizerWildPool[0]))

#endif // GUARD_DATA_RANDOMIZER_WILD_POOL_H
